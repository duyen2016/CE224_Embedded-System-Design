...
/* USER CODE BEGIN PV */
uint8_t receive_d[64];
uint8_t hello[64] = "Hello STM";
uint8_t on_L3[64] = "Turn on LED 3";
uint8_t on_L4[64] = "Turn on LED 4";
uint8_t off_L3[64] = "Turn off LED 3";
uint8_t off_L4[64] = "Turn off LED 4";
uint8_t G9[64] = "Good night";
/* USER CODE END PV */
